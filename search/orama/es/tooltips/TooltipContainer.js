...
function (_React$Component) {
  _inheritsLoose(TooltipContainer, _React$Component);
  ...
  _proto.getTranslation = function getTranslation() {
    ...
    var innerHeight = isBrowser ? window.innerHeight : 1000;
    var innerWidth = isBrowser ? window.innerWidth : 1000;
    var x;
  ...
  _proto.renderTooltip = function renderTooltip() {
    ...
    var _layerProps$Tooltip = layerProps.Tooltip,
        Tooltip = _layerProps$Tooltip === void 0 ? DefaultTooltip : _layerProps$Tooltip;
    var style = {
      pointerEvents: 'none',
      position: 'fixed',
      zIndex: 999999,
    ...
    return React.createElement("div", {
      style: style
    }, React.createElement(MeasuredContainer, {
  ...
  _proto.render = function render() {
    ...
    return hasEverMounted && React.createElement(Portal, null, !!mouse && !!hoverData && this.renderTooltip());
  };
